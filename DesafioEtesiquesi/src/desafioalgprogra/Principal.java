...
public class Principal {
    ...
    public void menu1() {
        int total;
        int opcion = 0;
        double traslacionX = 0;
        double traslacionY = 0;
        String puntoAux;
        while (true) {
            while(true){
            ...
            try {
                ...
                System.err.println("ERROR : Respuesta no válida...");
            }
            ...
            if (opcion == 1) { //llamar a los triangulos asfjkas
                ...
                double lado1 = ct.calcularLado(dato1X, dato1Y, dato2X, dato2Y);
                double lado2 = ct.calcularLado(dato2X, dato2Y, dato3X, dato3Y);
                double lado3 = ct.calcularLado(dato3X, dato3Y, dato1X, dato1Y);
                double perimetro = ct.calcularPerimetroTriangulo(lado1, lado2, lado3);
                ...
                double area = ct.calcularAreaTriangulo(lado1, lado2, lado3);
            ...
            if (opcion == 2) {//llamar a los cuadraditoos
                ...
                double ladoA = cc.calcularLado(datoX1, datoY1, datoX2, datoY2);
                double ladoB = cc.calcularLado(datoX2, datoY2, datoX3, datoY3);
                double ladoC = cc.calcularLado(datoX3, datoY3, datoX4, datoY4);
                double ladoD = cc.calcularLado(datoX4, datoY4, datoX1, datoY1);
                double ladoX = cc.calcularLado(datoX1, datoY1, datoX3, datoY3);
                double perimetroC = ladoA + ladoB + ladoC + ladoD;
