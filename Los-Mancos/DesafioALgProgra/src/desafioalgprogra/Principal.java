    ...
    public void menu1() {
        ...
        while (true) {
            ...
            if (opcion == 2) {//llamar a los cuadraditoos
                ...
                System.out.println("El angulo 2 es de : " + anguloB + "°");
                System.out.println("El angulo 3 es de : " + anguloC + "°");
                System.out.println("El angulo 4 es de : " + anguloD + "°");
                ...
                System.out.println("El púnto 1 es : (" + (int)(datoX1 + traslacionX) + "," + (int)(datoY1 + traslacionY) + ")");
                System.out.println("El púnto 2 es : (" + (int)(datoX2 + traslacionX) + "," + (int)(datoY2 + traslacionY) + ")");
                System.out.println("El púnto 3 es : (" + (int)(datoX3 + traslacionX) + "," + (int)(datoY3 + traslacionY) + ")");
                System.out.println("El púnto 4 es : (" + (int)(datoX4 + traslacionX) + "," + (int)(datoY4 + traslacionY) + ")");
